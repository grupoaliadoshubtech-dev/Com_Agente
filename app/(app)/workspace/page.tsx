    ...
    <div className="flex h-full" data-mobile-view={mobileView}>
      ...
      <div className="workspace-chat-panel flex-1 flex flex-col overflow-hidden">
        {selected ? (<>
          ...
          {/* Input + Anexo */}
          <div className="px-4 py-3 border-t flex gap-2 items-center flex-shrink-0 workspace-input-bar" style={{ borderColor: 'var(--border)', background: 'var(--bg-sidebar)' }}>
            {/* Botão de anexo */}
            ...
            <button onClick={sendMsg} disabled={sending || !input.trim()}
              ...
              {sending
                ...
                : <svg width="18" height="18" viewBox="0 0 24 24" fill="none" strokeLinecap="round" strokeLinejoin="round"><line x1="22" y1="2" x2="11" y2="13" stroke="currentColor" strokeWidth="2"/><polygon points="22 2 15 22 11 13 2 9 22 2" fill="currentColor"/></svg>
              }
            </button>
          </div>
        </>) : (
