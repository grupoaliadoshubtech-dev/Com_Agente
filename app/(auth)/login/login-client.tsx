...
export default function LoginClient() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    const res = await signIn('credentials', { redirect: false, email, password, remember: String(rememberMe) })
    setLoading(false)
        ...
        <div className="card" style={{ padding: 28 }}>
          ...
          {tab === 'login' && (
            <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              {/* Manter-me conectado + Esqueci minha senha */}
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: 7, cursor: 'pointer', userSelect: 'none' }}>
                  <input
                    ...
                    style={{ accentColor: 'var(--neon)', width: 15, height: 15, cursor: 'pointer', flexShrink: 0 }}
                  />
